...
class WikidataParser:
    ...
    def getProperty4Entity(self, entityData: dict, dict_rel: List[dict], savepath : str = '') -> dict:
        """
        ...
        ent_prop = [x for x in dict_rel if x['type'] == entityData['type']][0]
    ...
    def multi_getProperty4Entity(self, list_entities_data:List[dict], dict_rel:dict, n_core:int=4, savepath:str='') -> List[dict]:
        """
        ...
        with Pool(n_core) as p:
            partial_func = partial(self.getProperty4Entity, dict_rel = dict_rel, savepath=savepath)
            list_entities_data = p.map(partial_func, list_entities_data)
    ...
    def processListEntities(self, list_entities: List[str], dict_rel:dict, scorer:Callable = fuzz.partial_ratio, source_doc:str='wikipedia', score_cutoff:int=90, getOther:bool = False, maxsizesent:bool=False, maxsize:int = 0,n_core:int=4, savepath:str='') -> List[dict]:
        """
        ...
        list_entities_data = self.multi_getProperty4Entity(list_entities_data=list_entities_data, dict_rel=dict_rel, n_core=n_core, savepath=savepath)
